...
report_unmatched_points > ${REPORT_DIR_FORMALITY}/${DESIGN_NAME}.fmv_unmatched_points.rpt
...
if { ![verify] }  {  
  save_session -replace ${REPORT_DIR_FORMALITY}/${DESIGN_NAME}
  report_failing_points > ${REPORT_DIR_FORMALITY}/${DESIGN_NAME}.fmv_failing_points.rpt
  report_aborted > ${REPORT_DIR_FORMALITY}/${DESIGN_NAME}.fmv_aborted_points.rpt
  ...
  analyze_points -all > ${REPORT_DIR_FORMALITY}/${DESIGN_NAME}.fmv_analyze_points.rpt
  set fm_passed FALSE
} else {
  set fm_passed TRUE
}
