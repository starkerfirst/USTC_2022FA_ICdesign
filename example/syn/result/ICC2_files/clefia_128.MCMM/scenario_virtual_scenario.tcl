...
# Created by write_script -format dctcl for scenario constraints on Sun Jan  2 \
03:01:38 2022
...
/js1/baixf/teaching/PCD2021/example/syn/tech/tluplus/t018lo_1p5m_typical.tluplus \
-min_tluplus                                                                   \
/js1/baixf/teaching/PCD2021/example/syn/tech/tluplus/t018lo_1p5m_typical.tluplus \
-tech2itf_map /js1/baixf/teaching/PCD2021/example/syn/tech/tluplus/star.map_5M \
...
set_switching_activity -period 1 -toggle_rate 0.00043869 -static_probability   \
0.970993 [get_pins l_reg_27_/QN]
set_switching_activity -period 1 -toggle_rate 0.000473022 -static_probability  \
0.0287933 [get_pins l_reg_89_/Q]
set_switching_activity -period 1 -toggle_rate 0.000450897 -static_probability  \
0.970947 [get_pins l_reg_28_/QN]
set_switching_activity -period 1 -toggle_rate 0.000454712 -static_probability  \
0.97345 [get_pins l_reg_85_/QN]
set_switching_activity -period 1 -toggle_rate 0.00043335 -static_probability   \
0.972061 [get_pins l_reg_101_/QN]
set_switching_activity -period 1 -toggle_rate 0.000469208 -static_probability  \
0.0299072 [get_pins l_reg_68_/Q]
set_switching_activity -period 1 -toggle_rate 0.000432587 -static_probability  \
0.972717 [get_pins l_reg_43_/QN]
set_switching_activity -period 1 -toggle_rate 0.000418091 -static_probability  \
0.972534 [get_pins l_reg_100_/QN]
set_switching_activity -period 1 -toggle_rate 0.00043869 -static_probability   \
0.970398 [get_pins l_reg_98_/QN]
set_switching_activity -period 1 -toggle_rate 0.000449371 -static_probability  \
0.971085 [get_pins l_reg_94_/QN]
set_switching_activity -period 1 -toggle_rate 0.000442505 -static_probability  \
0.971359 [get_pins l_reg_30_/QN]
set_switching_activity -period 1 -toggle_rate 0.000442505 -static_probability  \
0.0291595 [get_pins l_reg_86_/Q]
set_switching_activity -period 1 -toggle_rate 0.000450897 -static_probability  \
0.973206 [get_pins l_reg_23_/QN]
set_switching_activity -period 1 -toggle_rate 0.000463867 -static_probability  \
0.969345 [get_pins l_reg_91_/QN]
set_switching_activity -period 1 -toggle_rate 0.00041275 -static_probability   \
0.974213 [get_pins l_reg_107_/QN]
set_switching_activity -period 1 -toggle_rate 0.000442505 -static_probability  \
0.971237 [get_pins l_reg_87_/QN]
set_switching_activity -period 1 -toggle_rate 0.000415039 -static_probability  \
0.970352 [get_pins l_reg_38_/QN]
set_switching_activity -period 1 -toggle_rate 0.000442505 -static_probability  \
0.971375 [get_pins l_reg_36_/QN]
set_switching_activity -period 1 -toggle_rate 0.00560532 -static_probability   \
0.763046 [get_pins rin_reg_0_/QN]
set_switching_activity -period 1 -toggle_rate 0.000440216 -static_probability  \
0.970032 [get_pins l_reg_34_/QN]
set_switching_activity -period 1 -toggle_rate 0.000428772 -static_probability  \
0.971542 [get_pins l_reg_35_/QN]
set_switching_activity -period 1 -toggle_rate 0.000415802 -static_probability  \
0.97374 [get_pins l_reg_99_/QN]
set_switching_activity -period 1 -toggle_rate 0.000431824 -static_probability  \
0.969574 [get_pins l_reg_102_/QN]
set_switching_activity -period 1 -toggle_rate 0.000414276 -static_probability  \
0.969345 [get_pins l_reg_37_/QN]
set_switching_activity -period 1 -toggle_rate 0.000441742 -static_probability  \
0.970673 [get_pins l_reg_33_/QN]
set_switching_activity -period 1 -toggle_rate 0.000443268 -static_probability  \
0.970459 [get_pins l_reg_46_/QN]
set_switching_activity -period 1 -toggle_rate 0.000411224 -static_probability  \
0.970428 [get_pins l_reg_97_/QN]
set_switching_activity -period 1 -toggle_rate 0.000445557 -static_probability  \
0.970154 [get_pins l_reg_110_/QN]
set_switching_activity -period 1 -toggle_rate 0.00555115 -static_probability   \
0.759476 [get_pins rin_reg_33_/QN]
set_switching_activity -period 1 -toggle_rate 0.000453186 -static_probability  \
0.972122 [get_pins l_reg_21_/QN]
set_switching_activity -period 1 -toggle_rate 0.000442505 -static_probability  \
0.973099 [get_pins l_reg_14_/QN]
set_switching_activity -period 1 -toggle_rate 0.000434113 -static_probability  \
0.0283813 [get_pins l_reg_76_/Q]
set_switching_activity -period 1 -toggle_rate 0.000426483 -static_probability  \
0.97467 [get_pins l_reg_92_/QN]
set_switching_activity -period 1 -toggle_rate 0.000443268 -static_probability  \
0.0278015 [get_pins l_reg_74_/Q]
set_switching_activity -period 1 -toggle_rate 0.00044632 -static_probability   \
0.974014 [get_pins l_reg_78_/QN]
set_switching_activity -period 1 -toggle_rate 0.000468445 -static_probability  \
0.973434 [get_pins l_reg_71_/QN]
set_switching_activity -period 1 -toggle_rate 0.000454712 -static_probability  \
0.971039 [get_pins l_reg_64_/QN]
set_switching_activity -period 1 -toggle_rate 0.000452423 -static_probability  \
0.971512 [get_pins l_reg_0_/QN]
set_switching_activity -period 1 -toggle_rate 0.000429535 -static_probability  \
0.0287018 [get_pins l_reg_79_/Q]
set_switching_activity -period 1 -toggle_rate 0.000444794 -static_probability  \
0.030365 [get_pins l_reg_65_/Q]
set_switching_activity -period 1 -toggle_rate 0.000434113 -static_probability  \
0.0269775 [get_pins l_reg_88_/Q]
set_switching_activity -period 1 -toggle_rate 0.000440979 -static_probability  \
0.973068 [get_pins l_reg_7_/QN]
create_clock [get_ports clk]  -period 40  -waveform {0 20}
set_clock_uncertainty -setup 0.5  [get_clocks clk]
group_path -name FEEDTHROUGH  -from [list [get_ports reset_n] [get_ports       \
{k[127]}] [get_ports {k[126]}] [get_ports {k[125]}] [get_ports {k[124]}]       \
[get_ports {k[123]}] [get_ports {k[122]}] [get_ports {k[121]}] [get_ports      \
{k[120]}] [get_ports {k[119]}] [get_ports {k[118]}] [get_ports {k[117]}]       \
[get_ports {k[116]}] [get_ports {k[115]}] [get_ports {k[114]}] [get_ports      \
{k[113]}] [get_ports {k[112]}] [get_ports {k[111]}] [get_ports {k[110]}]       \
[get_ports {k[109]}] [get_ports {k[108]}] [get_ports {k[107]}] [get_ports      \
{k[106]}] [get_ports {k[105]}] [get_ports {k[104]}] [get_ports {k[103]}]       \
[get_ports {k[102]}] [get_ports {k[101]}] [get_ports {k[100]}] [get_ports      \
{k[99]}] [get_ports {k[98]}] [get_ports {k[97]}] [get_ports {k[96]}]           \
[get_ports {k[95]}] [get_ports {k[94]}] [get_ports {k[93]}] [get_ports         \
{k[92]}] [get_ports {k[91]}] [get_ports {k[90]}] [get_ports {k[89]}]           \
[get_ports {k[88]}] [get_ports {k[87]}] [get_ports {k[86]}] [get_ports         \
{k[85]}] [get_ports {k[84]}] [get_ports {k[83]}] [get_ports {k[82]}]           \
[get_ports {k[81]}] [get_ports {k[80]}] [get_ports {k[79]}] [get_ports         \
{k[78]}] [get_ports {k[77]}] [get_ports {k[76]}] [get_ports {k[75]}]           \
[get_ports {k[74]}] [get_ports {k[73]}] [get_ports {k[72]}] [get_ports         \
{k[71]}] [get_ports {k[70]}] [get_ports {k[69]}] [get_ports {k[68]}]           \
[get_ports {k[67]}] [get_ports {k[66]}] [get_ports {k[65]}] [get_ports         \
{k[64]}] [get_ports {k[63]}] [get_ports {k[62]}] [get_ports {k[61]}]           \
[get_ports {k[60]}] [get_ports {k[59]}] [get_ports {k[58]}] [get_ports         \
{k[57]}] [get_ports {k[56]}] [get_ports {k[55]}] [get_ports {k[54]}]           \
[get_ports {k[53]}] [get_ports {k[52]}] [get_ports {k[51]}] [get_ports         \
{k[50]}] [get_ports {k[49]}] [get_ports {k[48]}] [get_ports {k[47]}]           \
[get_ports {k[46]}] [get_ports {k[45]}] [get_ports {k[44]}] [get_ports         \
{k[43]}] [get_ports {k[42]}] [get_ports {k[41]}] [get_ports {k[40]}]           \
[get_ports {k[39]}] [get_ports {k[38]}] [get_ports {k[37]}] [get_ports         \
{k[36]}] [get_ports {k[35]}] [get_ports {k[34]}] [get_ports {k[33]}]           \
[get_ports {k[32]}] [get_ports {k[31]}] [get_ports {k[30]}] [get_ports         \
{k[29]}] [get_ports {k[28]}] [get_ports {k[27]}] [get_ports {k[26]}]           \
[get_ports {k[25]}] [get_ports {k[24]}] [get_ports {k[23]}] [get_ports         \
{k[22]}] [get_ports {k[21]}] [get_ports {k[20]}] [get_ports {k[19]}]           \
[get_ports {k[18]}] [get_ports {k[17]}] [get_ports {k[16]}] [get_ports         \
{k[15]}] [get_ports {k[14]}] [get_ports {k[13]}] [get_ports {k[12]}]           \
[get_ports {k[11]}] [get_ports {k[10]}] [get_ports {k[9]}] [get_ports {k[8]}]  \
[get_ports {k[7]}] [get_ports {k[6]}] [get_ports {k[5]}] [get_ports {k[4]}]    \
[get_ports {k[3]}] [get_ports {k[2]}] [get_ports {k[1]}] [get_ports {k[0]}]    \
[get_ports {p[127]}] [get_ports {p[126]}] [get_ports {p[125]}] [get_ports      \
{p[124]}] [get_ports {p[123]}] [get_ports {p[122]}] [get_ports {p[121]}]       \
[get_ports {p[120]}] [get_ports {p[119]}] [get_ports {p[118]}] [get_ports      \
{p[117]}] [get_ports {p[116]}] [get_ports {p[115]}] [get_ports {p[114]}]       \
[get_ports {p[113]}] [get_ports {p[112]}] [get_ports {p[111]}] [get_ports      \
{p[110]}] [get_ports {p[109]}] [get_ports {p[108]}] [get_ports {p[107]}]       \
[get_ports {p[106]}] [get_ports {p[105]}] [get_ports {p[104]}] [get_ports      \
{p[103]}] [get_ports {p[102]}] [get_ports {p[101]}] [get_ports {p[100]}]       \
[get_ports {p[99]}] [get_ports {p[98]}] [get_ports {p[97]}] [get_ports         \
{p[96]}] [get_ports {p[95]}] [get_ports {p[94]}] [get_ports {p[93]}]           \
[get_ports {p[92]}] [get_ports {p[91]}] [get_ports {p[90]}] [get_ports         \
{p[89]}] [get_ports {p[88]}] [get_ports {p[87]}] [get_ports {p[86]}]           \
[get_ports {p[85]}] [get_ports {p[84]}] [get_ports {p[83]}] [get_ports         \
{p[82]}] [get_ports {p[81]}] [get_ports {p[80]}] [get_ports {p[79]}]           \
[get_ports {p[78]}] [get_ports {p[77]}] [get_ports {p[76]}] [get_ports         \
{p[75]}] [get_ports {p[74]}] [get_ports {p[73]}] [get_ports {p[72]}]           \
[get_ports {p[71]}] [get_ports {p[70]}] [get_ports {p[69]}] [get_ports         \
{p[68]}] [get_ports {p[67]}] [get_ports {p[66]}] [get_ports {p[65]}]           \
[get_ports {p[64]}] [get_ports {p[63]}] [get_ports {p[62]}] [get_ports         \
{p[61]}] [get_ports {p[60]}] [get_ports {p[59]}] [get_ports {p[58]}]           \
[get_ports {p[57]}] [get_ports {p[56]}] [get_ports {p[55]}] [get_ports         \
{p[54]}] [get_ports {p[53]}] [get_ports {p[52]}] [get_ports {p[51]}]           \
[get_ports {p[50]}] [get_ports {p[49]}] [get_ports {p[48]}] [get_ports         \
{p[47]}] [get_ports {p[46]}] [get_ports {p[45]}] [get_ports {p[44]}]           \
[get_ports {p[43]}] [get_ports {p[42]}] [get_ports {p[41]}] [get_ports         \
{p[40]}] [get_ports {p[39]}] [get_ports {p[38]}] [get_ports {p[37]}]           \
[get_ports {p[36]}] [get_ports {p[35]}] [get_ports {p[34]}] [get_ports         \
{p[33]}] [get_ports {p[32]}] [get_ports {p[31]}] [get_ports {p[30]}]           \
[get_ports {p[29]}] [get_ports {p[28]}] [get_ports {p[27]}] [get_ports         \
{p[26]}] [get_ports {p[25]}] [get_ports {p[24]}] [get_ports {p[23]}]           \
[get_ports {p[22]}] [get_ports {p[21]}] [get_ports {p[20]}] [get_ports         \
{p[19]}] [get_ports {p[18]}] [get_ports {p[17]}] [get_ports {p[16]}]           \
[get_ports {p[15]}] [get_ports {p[14]}] [get_ports {p[13]}] [get_ports         \
{p[12]}] [get_ports {p[11]}] [get_ports {p[10]}] [get_ports {p[9]}] [get_ports \
{p[8]}] [get_ports {p[7]}] [get_ports {p[6]}] [get_ports {p[5]}] [get_ports    \
{p[4]}] [get_ports {p[3]}] [get_ports {p[2]}] [get_ports {p[1]}] [get_ports    \
{p[0]}] [get_ports start]]  -to [list [get_ports {c[127]}] [get_ports          \
{c[126]}] [get_ports {c[125]}] [get_ports {c[124]}] [get_ports {c[123]}]       \
[get_ports {c[122]}] [get_ports {c[121]}] [get_ports {c[120]}] [get_ports      \
{c[119]}] [get_ports {c[118]}] [get_ports {c[117]}] [get_ports {c[116]}]       \
[get_ports {c[115]}] [get_ports {c[114]}] [get_ports {c[113]}] [get_ports      \
{c[112]}] [get_ports {c[111]}] [get_ports {c[110]}] [get_ports {c[109]}]       \
[get_ports {c[108]}] [get_ports {c[107]}] [get_ports {c[106]}] [get_ports      \
{c[105]}] [get_ports {c[104]}] [get_ports {c[103]}] [get_ports {c[102]}]       \
[get_ports {c[101]}] [get_ports {c[100]}] [get_ports {c[99]}] [get_ports       \
{c[98]}] [get_ports {c[97]}] [get_ports {c[96]}] [get_ports {c[95]}]           \
[get_ports {c[94]}] [get_ports {c[93]}] [get_ports {c[92]}] [get_ports         \
{c[91]}] [get_ports {c[90]}] [get_ports {c[89]}] [get_ports {c[88]}]           \
[get_ports {c[87]}] [get_ports {c[86]}] [get_ports {c[85]}] [get_ports         \
{c[84]}] [get_ports {c[83]}] [get_ports {c[82]}] [get_ports {c[81]}]           \
[get_ports {c[80]}] [get_ports {c[79]}] [get_ports {c[78]}] [get_ports         \
{c[77]}] [get_ports {c[76]}] [get_ports {c[75]}] [get_ports {c[74]}]           \
[get_ports {c[73]}] [get_ports {c[72]}] [get_ports {c[71]}] [get_ports         \
{c[70]}] [get_ports {c[69]}] [get_ports {c[68]}] [get_ports {c[67]}]           \
[get_ports {c[66]}] [get_ports {c[65]}] [get_ports {c[64]}] [get_ports         \
...
[get_ports {c[2]}] [get_ports {c[1]}] [get_ports {c[0]}] [get_ports done]]
group_path -name REGIN  -from [list [get_ports reset_n] [get_ports {k[127]}]   \
[get_ports {k[126]}] [get_ports {k[125]}] [get_ports {k[124]}] [get_ports      \
{k[123]}] [get_ports {k[122]}] [get_ports {k[121]}] [get_ports {k[120]}]       \
[get_ports {k[119]}] [get_ports {k[118]}] [get_ports {k[117]}] [get_ports      \
{k[116]}] [get_ports {k[115]}] [get_ports {k[114]}] [get_ports {k[113]}]       \
[get_ports {k[112]}] [get_ports {k[111]}] [get_ports {k[110]}] [get_ports      \
{k[109]}] [get_ports {k[108]}] [get_ports {k[107]}] [get_ports {k[106]}]       \
[get_ports {k[105]}] [get_ports {k[104]}] [get_ports {k[103]}] [get_ports      \
{k[102]}] [get_ports {k[101]}] [get_ports {k[100]}] [get_ports {k[99]}]        \
[get_ports {k[98]}] [get_ports {k[97]}] [get_ports {k[96]}] [get_ports         \
{k[95]}] [get_ports {k[94]}] [get_ports {k[93]}] [get_ports {k[92]}]           \
[get_ports {k[91]}] [get_ports {k[90]}] [get_ports {k[89]}] [get_ports         \
{k[88]}] [get_ports {k[87]}] [get_ports {k[86]}] [get_ports {k[85]}]           \
[get_ports {k[84]}] [get_ports {k[83]}] [get_ports {k[82]}] [get_ports         \
{k[81]}] [get_ports {k[80]}] [get_ports {k[79]}] [get_ports {k[78]}]           \
[get_ports {k[77]}] [get_ports {k[76]}] [get_ports {k[75]}] [get_ports         \
{k[74]}] [get_ports {k[73]}] [get_ports {k[72]}] [get_ports {k[71]}]           \
[get_ports {k[70]}] [get_ports {k[69]}] [get_ports {k[68]}] [get_ports         \
{k[67]}] [get_ports {k[66]}] [get_ports {k[65]}] [get_ports {k[64]}]           \
[get_ports {k[63]}] [get_ports {k[62]}] [get_ports {k[61]}] [get_ports         \
{k[60]}] [get_ports {k[59]}] [get_ports {k[58]}] [get_ports {k[57]}]           \
[get_ports {k[56]}] [get_ports {k[55]}] [get_ports {k[54]}] [get_ports         \
{k[53]}] [get_ports {k[52]}] [get_ports {k[51]}] [get_ports {k[50]}]           \
[get_ports {k[49]}] [get_ports {k[48]}] [get_ports {k[47]}] [get_ports         \
{k[46]}] [get_ports {k[45]}] [get_ports {k[44]}] [get_ports {k[43]}]           \
[get_ports {k[42]}] [get_ports {k[41]}] [get_ports {k[40]}] [get_ports         \
{k[39]}] [get_ports {k[38]}] [get_ports {k[37]}] [get_ports {k[36]}]           \
[get_ports {k[35]}] [get_ports {k[34]}] [get_ports {k[33]}] [get_ports         \
{k[32]}] [get_ports {k[31]}] [get_ports {k[30]}] [get_ports {k[29]}]           \
[get_ports {k[28]}] [get_ports {k[27]}] [get_ports {k[26]}] [get_ports         \
{k[25]}] [get_ports {k[24]}] [get_ports {k[23]}] [get_ports {k[22]}]           \
[get_ports {k[21]}] [get_ports {k[20]}] [get_ports {k[19]}] [get_ports         \
{k[18]}] [get_ports {k[17]}] [get_ports {k[16]}] [get_ports {k[15]}]           \
[get_ports {k[14]}] [get_ports {k[13]}] [get_ports {k[12]}] [get_ports         \
{k[11]}] [get_ports {k[10]}] [get_ports {k[9]}] [get_ports {k[8]}] [get_ports  \
{k[7]}] [get_ports {k[6]}] [get_ports {k[5]}] [get_ports {k[4]}] [get_ports    \
{k[3]}] [get_ports {k[2]}] [get_ports {k[1]}] [get_ports {k[0]}] [get_ports    \
{p[127]}] [get_ports {p[126]}] [get_ports {p[125]}] [get_ports {p[124]}]       \
[get_ports {p[123]}] [get_ports {p[122]}] [get_ports {p[121]}] [get_ports      \
{p[120]}] [get_ports {p[119]}] [get_ports {p[118]}] [get_ports {p[117]}]       \
[get_ports {p[116]}] [get_ports {p[115]}] [get_ports {p[114]}] [get_ports      \
{p[113]}] [get_ports {p[112]}] [get_ports {p[111]}] [get_ports {p[110]}]       \
[get_ports {p[109]}] [get_ports {p[108]}] [get_ports {p[107]}] [get_ports      \
{p[106]}] [get_ports {p[105]}] [get_ports {p[104]}] [get_ports {p[103]}]       \
[get_ports {p[102]}] [get_ports {p[101]}] [get_ports {p[100]}] [get_ports      \
{p[99]}] [get_ports {p[98]}] [get_ports {p[97]}] [get_ports {p[96]}]           \
[get_ports {p[95]}] [get_ports {p[94]}] [get_ports {p[93]}] [get_ports         \
{p[92]}] [get_ports {p[91]}] [get_ports {p[90]}] [get_ports {p[89]}]           \
[get_ports {p[88]}] [get_ports {p[87]}] [get_ports {p[86]}] [get_ports         \
{p[85]}] [get_ports {p[84]}] [get_ports {p[83]}] [get_ports {p[82]}]           \
[get_ports {p[81]}] [get_ports {p[80]}] [get_ports {p[79]}] [get_ports         \
{p[78]}] [get_ports {p[77]}] [get_ports {p[76]}] [get_ports {p[75]}]           \
[get_ports {p[74]}] [get_ports {p[73]}] [get_ports {p[72]}] [get_ports         \
{p[71]}] [get_ports {p[70]}] [get_ports {p[69]}] [get_ports {p[68]}]           \
[get_ports {p[67]}] [get_ports {p[66]}] [get_ports {p[65]}] [get_ports         \
{p[64]}] [get_ports {p[63]}] [get_ports {p[62]}] [get_ports {p[61]}]           \
...
[get_ports start]]
group_path -name REGOUT  -to [list [get_ports {c[127]}] [get_ports {c[126]}]   \
[get_ports {c[125]}] [get_ports {c[124]}] [get_ports {c[123]}] [get_ports      \
{c[122]}] [get_ports {c[121]}] [get_ports {c[120]}] [get_ports {c[119]}]       \
[get_ports {c[118]}] [get_ports {c[117]}] [get_ports {c[116]}] [get_ports      \
{c[115]}] [get_ports {c[114]}] [get_ports {c[113]}] [get_ports {c[112]}]       \
[get_ports {c[111]}] [get_ports {c[110]}] [get_ports {c[109]}] [get_ports      \
{c[108]}] [get_ports {c[107]}] [get_ports {c[106]}] [get_ports {c[105]}]       \
[get_ports {c[104]}] [get_ports {c[103]}] [get_ports {c[102]}] [get_ports      \
{c[101]}] [get_ports {c[100]}] [get_ports {c[99]}] [get_ports {c[98]}]         \
[get_ports {c[97]}] [get_ports {c[96]}] [get_ports {c[95]}] [get_ports         \
{c[94]}] [get_ports {c[93]}] [get_ports {c[92]}] [get_ports {c[91]}]           \
[get_ports {c[90]}] [get_ports {c[89]}] [get_ports {c[88]}] [get_ports         \
{c[87]}] [get_ports {c[86]}] [get_ports {c[85]}] [get_ports {c[84]}]           \
[get_ports {c[83]}] [get_ports {c[82]}] [get_ports {c[81]}] [get_ports         \
{c[80]}] [get_ports {c[79]}] [get_ports {c[78]}] [get_ports {c[77]}]           \
[get_ports {c[76]}] [get_ports {c[75]}] [get_ports {c[74]}] [get_ports         \
{c[73]}] [get_ports {c[72]}] [get_ports {c[71]}] [get_ports {c[70]}]           \
[get_ports {c[69]}] [get_ports {c[68]}] [get_ports {c[67]}] [get_ports         \
{c[66]}] [get_ports {c[65]}] [get_ports {c[64]}] [get_ports {c[63]}]           \
[get_ports {c[62]}] [get_ports {c[61]}] [get_ports {c[60]}] [get_ports         \
{c[59]}] [get_ports {c[58]}] [get_ports {c[57]}] [get_ports {c[56]}]           \
[get_ports {c[55]}] [get_ports {c[54]}] [get_ports {c[53]}] [get_ports         \
{c[52]}] [get_ports {c[51]}] [get_ports {c[50]}] [get_ports {c[49]}]           \
[get_ports {c[48]}] [get_ports {c[47]}] [get_ports {c[46]}] [get_ports         \
{c[45]}] [get_ports {c[44]}] [get_ports {c[43]}] [get_ports {c[42]}]           \
[get_ports {c[41]}] [get_ports {c[40]}] [get_ports {c[39]}] [get_ports         \
{c[38]}] [get_ports {c[37]}] [get_ports {c[36]}] [get_ports {c[35]}]           \
[get_ports {c[34]}] [get_ports {c[33]}] [get_ports {c[32]}] [get_ports         \
{c[31]}] [get_ports {c[30]}] [get_ports {c[29]}] [get_ports {c[28]}]           \
[get_ports {c[27]}] [get_ports {c[26]}] [get_ports {c[25]}] [get_ports         \
{c[24]}] [get_ports {c[23]}] [get_ports {c[22]}] [get_ports {c[21]}]           \
[get_ports {c[20]}] [get_ports {c[19]}] [get_ports {c[18]}] [get_ports         \
{c[17]}] [get_ports {c[16]}] [get_ports {c[15]}] [get_ports {c[14]}]           \
[get_ports {c[13]}] [get_ports {c[12]}] [get_ports {c[11]}] [get_ports         \
{c[10]}] [get_ports {c[9]}] [get_ports {c[8]}] [get_ports {c[7]}] [get_ports   \
{c[6]}] [get_ports {c[5]}] [get_ports {c[4]}] [get_ports {c[3]}] [get_ports    \
{c[2]}] [get_ports {c[1]}] [get_ports {c[0]}] [get_ports done]]
