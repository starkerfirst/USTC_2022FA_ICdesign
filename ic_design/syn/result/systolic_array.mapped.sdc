...
# Created by write_sdc on Thu Feb 9 12:11:30 2023
...
group_path -name FEEDTHROUGH  -from [list [get_ports rstn_p] [get_ports en_p] [get_ports {p_shift_in[7]}] [get_ports {p_shift_in[6]}] [get_ports {p_shift_in[5]}] [get_ports {p_shift_in[4]}] [get_ports {p_shift_in[3]}] [get_ports {p_shift_in[2]}] [get_ports {p_shift_in[1]}] [get_ports {p_shift_in[0]}]]  -to [list [get_ports {p_shift_out[7]}] [get_ports {p_shift_out[6]}] [get_ports {p_shift_out[5]}] [get_ports {p_shift_out[4]}] [get_ports {p_shift_out[3]}] [get_ports {p_shift_out[2]}] [get_ports {p_shift_out[1]}] [get_ports {p_shift_out[0]}] [get_ports ack_p]]
group_path -name REGIN  -from [list [get_ports rstn_p] [get_ports en_p] [get_ports {p_shift_in[7]}] [get_ports {p_shift_in[6]}] [get_ports {p_shift_in[5]}] [get_ports {p_shift_in[4]}] [get_ports {p_shift_in[3]}] [get_ports {p_shift_in[2]}] [get_ports {p_shift_in[1]}] [get_ports {p_shift_in[0]}]]
