if { [namespace current] != {::63A28A94} } { error {This script [file tail [info script]] should not be sourced directly}; }
###################################################################

# Created by write_script -format dctcl for scenario constraints on Wed Dec 21 \
12:24:52 2022
...
[get_ports {p_shift_in_A[7]}] [get_ports {p_shift_in_A[6]}] [get_ports         \
{p_shift_in_A[5]}] [get_ports {p_shift_in_A[4]}] [get_ports {p_shift_in_A[3]}] \
[get_ports {p_shift_in_A[2]}] [get_ports {p_shift_in_A[1]}] [get_ports         \
{p_shift_in_A[0]}] [get_ports {p_shift_in_B[7]}] [get_ports {p_shift_in_B[6]}] \
[get_ports {p_shift_in_B[5]}] [get_ports {p_shift_in_B[4]}] [get_ports         \
{p_shift_in_B[3]}] [get_ports {p_shift_in_B[2]}] [get_ports {p_shift_in_B[1]}] \
[get_ports {p_shift_in_B[0]}]]  -to [list [get_ports {p_shift_out[7]}]         \
[get_ports {p_shift_out[6]}] [get_ports {p_shift_out[5]}] [get_ports           \
{p_shift_out[4]}] [get_ports {p_shift_out[3]}] [get_ports {p_shift_out[2]}]    \
[get_ports {p_shift_out[1]}] [get_ports {p_shift_out[0]}] [get_ports ack_p]]
